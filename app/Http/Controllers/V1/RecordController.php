...
class RecordController extends Controller
{
    ...
    public function getAllOpinion(Request $request)
    {
        ...
        //dd($userid);
        $perpage = $request->input('per_page');
        $record = DB::table('bu_user_question_report')
            ->select('bu_user_question_report.law_rule_ids','bu_user_question_report.case_ids','bu_user_question_report.suggest_ids','users.user_name','users.province_id','users.city_id')
            ->where('topics.user_id',$userid)
            ->paginate($perpage)
            ->toArray();
